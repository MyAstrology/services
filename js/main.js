...
// ============================================================
// মাল্টি-ইনপুট চেক - শুধুমাত্র স্পষ্ট বিভাজক থাকলেই
// ============================================================
function isExplicitMultiInput(input) {
    // শুধুমাত্র + বা এবং বা & বা , থাকলেই মাল্টি-ইনপুট
    // স্পেস বা অন্যান্য ক্যারেক্টার মাল্টি-ইনপুট হিসেবে ধরা হবে না
    const explicitSeparators = /[\+\&\|\,\s+(এবং)\s+(and)\s+]/i;
    
    // প্রথমে চেক করুন স্পষ্ট বিভাজক আছে কিনা
    if (!explicitSeparators.test(input)) {
        return false;
    }
    
    // বিভাজক দিয়ে ভাগ করুন
    const parts = input.split(/[\+\&\|\,\s+(এবং)\s+(and)\s+]+/i).filter(p => p.trim().length > 0);
    
    // যদি ২ বা তার বেশি অংশ হয়
    if (parts.length >= 2) {
        // চেক করুন প্রতিটি অংশ যুক্তিপূর্ণ কিনা
        let validParts = 0;
        for (let part of parts) {
            const trimmed = part.trim();
            // যদি অংশটি নামের মতো হয় (অক্ষর) বা সংখ্যা হয়
            if (/^[ঙ-হA-Za-z0-9\s]{2,}$/i.test(trimmed) || /^\d+$/.test(trimmed)) {
                validParts++;
            }
        }
        // যদি কমপক্ষে ২টি অংশ যুক্তিপূর্ণ হয়
        if (validParts >= 2) {
            return true;
        }
    }
...
// ============================================================
// অটো ডিটেক্ট ক্যাটাগরি (সিঙ্গেল ইনপুটের জন্য)
// ============================================================
...
// ============================================================
// সিঙ্গেল ইনপুট রেন্ডার (২৪টি ক্যাটাগরি)
// ============================================================
...
// ============================================================
// মূল সংখ্যার বিস্তারিত ব্যাখ্যা
// ============================================================
...
// ============================================================
// মাল্টি-ইনপুট রেন্ডার (সামঞ্জস্য মিলন)
// ============================================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============================================================
    // ধাপ ১: স্পষ্ট মাল্টি-ইনপুট চেক (+, এবং, &, , থাকলেই)
    // ============================================================
    ...
    // ============================================================
    // ধাপ ২: সিঙ্গেল ইনপুট - সংখ্যা বের করো
    // ============================================================
    ...
    // ============================================================
    // ধাপ ৩: যুক্তিপূর্ণ সিঙ্গেল ইনপুট → সরাসরি রেজাল্ট
    // ============================================================
    ...
    // ============================================================
    // ধাপ ৪: যুক্তিহীন সিঙ্গেল ইনপুট → ২৪টি ক্যাটাগরি দেখাও
    // ============================================================
