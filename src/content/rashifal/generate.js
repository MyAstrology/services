...
if (process.env.TARGET_DATE && process.env.TARGET_DATE !== '') {
  ...
  TARGET_DATE = new Date(process.env.TARGET_DATE + 'T00:00:00Z'); // ✅ UTC midnight — IST timezone drift ঠেকাতে Z আবশ্যক
  ...
  return JSON.stringify([
    // NewsArticle Schema
    {
      ...
      "about": [
        ...
        { "@type": "Thing", "name": "পঞ্চাঙ্গ" },
        { "@type": "Thing", "name": `চন্দ্র ${moonRashiName} রাশি` },
        { "@type": "Thing", "name": `সূর্য ${sunRashiName} রাশি` },
        { "@type": "Thing", "name": panchang.tithi },
        { "@type": "Thing", "name": panchang.nakshatra }
      ]
    },
    // WebPage Schema — প্রতিটি তারিখ আলাদা entity হিসেবে index হয়
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "@id": `${SITE_URL}/rashifal/${iso}.html`,
      "name": `${bnDate} দৈনিক রাশিফল | MyAstrology`,
      "description": `${bnDate} — ১২ রাশির বিস্তারিত রাশিফল। চন্দ্র ${moonRashiName} রাশিতে। তিথি: ${panchang.tithi}, নক্ষত্র: ${panchang.nakshatra}।`,
      "url": `${SITE_URL}/rashifal/${iso}.html`,
      "inLanguage": "bn-IN",
      "isPartOf": { "@type": "WebSite", "url": SITE_URL, "name": "MyAstrology" },
      "datePublished": `${iso}T05:00:00+05:30`,
      "dateModified": `${iso}T05:00:00+05:30`,
      "breadcrumb": {
        "@type": "BreadcrumbList",
    ...
    // BreadcrumbList Schema (standalone — Google দুইবার parse করে)
    {
      "@context": "https://schema.org",
      "@type": "BreadcrumbList",
      "itemListElement": [
    ...
    // Organization Schema — AggregateRating সহ (Google search-এ ⭐ দেখাবে)
    {
      "@context": "https://schema.org",
      "@type": "Organization",
...
(async function main() {
  try {
    ...
    let html = templateContent
      ...
      // ★ নতুন: তারিখ-নির্দিষ্ট article:tag (template-এ {{ARTICLE_TAGS}} placeholder রাখুন)
      .replace('{{ARTICLE_TAGS}}', `${bnDate} রাশিফল, চন্দ্র ${moonRashiName} রাশি, সূর্য ${sunRashiName} রাশি, ${panchang.tithi}, ${panchang.nakshatra}, ${panchang.yoga}, বৈদিক জ্যোতিষ, বাংলা রাশিফল, দৈনিক রাশিফল`)
      // ★ নতুন: Bing verification (template-এ {{BING_VERIFICATION}} placeholder রাখুন)
      .replace('{{BING_VERIFICATION}}', '<meta name="msvalidate.01" content="984EF24A6EC23EFF015DCA989DAAD547">')
      // ★ নতুন: RSS feed link (template-এ {{RSS_LINK}} placeholder রাখুন)
      .replace('{{RSS_LINK}}', `<link rel="alternate" type="application/rss+xml" title="MyAstrology দৈনিক রাশিফল" href="${SITE_URL}/rashifal/rss.xml">`)
    ...
    console.log('\n🎉 সম্পন্ন! Daily rashifal generation v3.1 complete.');
    ...
    console.log('   ✓ JSON-LD স্কিমা (NewsArticle + WebPage + FAQPage + BreadcrumbList + Organization+AggregateRating)');
    console.log('   ✓ মাস্টার আর্কাইভ মাস-ফিল্টার সহ');
    console.log('   ✓ নিউজ সাইটম্যাপ ও প্রধান সাইটম্যাপ');
    console.log('   ✓ Bing verification, RSS feed link, dynamic article:tag');
