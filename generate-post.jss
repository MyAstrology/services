...
/* ★★★ গুরুত্বপূর্ণ: CLS দূর করার জন্য ইমেজ স্পেস রিজার্ভ ★★★ */
.featured-img {
  width: 100%;
...
.post-body img {
  ...
  /* CLS প্রতিরোধ: ইমেজ লোডের আগে স্পেস রিজার্ভ */
...
@keyframes waPulse {
  ...
  50% {
    box-shadow: 0 4px 34px rgba(37, 211, 102, 0.8), 0 0 0 8px rgba(37, 211, 102, 0.1);
  }
}
