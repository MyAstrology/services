...
.nav a i{width:20px;margin-right:9px;color:var(--gold3);opacity:.85;}.nav a:hover{background:rgba(184,134,11,.12);color:var(--gold-lt);}.nav a.wa-nav{color:#4ade80;font-weight:700;}
...
/* FOOTER REDESIGN */
.site-footer{background:linear-gradient(180deg,#08111f 0%,#03070f 100%);border-top:3px solid var(--gold);margin-top:50px;}
...
<header class="site-header">
  <button class="ham" onclick="toggleNav()" aria-label="মেনু"><i class="fas fa-bars"></i></button>
  <span class="header-brand">MyAstrology<span class="header-sub">ড. প্রদ্যুৎ আচার্য &middot; রানাঘাট</span></span>
  <img src="https://www.myastrology.in/images/MyAstrology-Ranghat-logo.png" alt="MyAstrology Logo" class="header-logo" width="46" height="46" loading="eager">
</header>
...
<main id="main-content">
  <a class="back-link" href="https://www.myastrology.in/blog-list.html"><i class="fas fa-arrow-left"></i> সব পোস্ট দেখুন</a>
...
${body}
  ...
  <div class="pjk-strip">
    ...
    <div class="pjk-tags">
      <a href="https://www.myastrology.in/panjika.html">❤️ প্রেম</a><a href="https://www.myastrology.in/panjika.html">💼 কর্ম</a><a href="https://www.myastrology.in/panjika.html">💰 অর্থ</a><a href="https://www.myastrology.in/panjika.html">🌿 স্বাস্থ্য</a><a href="https://www.myastrology.in/panjika.html">🔢 শুভ সংখ্যা</a><a href="https://www.myastrology.in/panjika.html">⏰ শুভ সময়</a>
    </div>
    <a class="pjk-btn" href="https://www.myastrology.in/panjika.html">আজই দেখুন &rarr;</a>
  </div>
  <div class="cta-box">
    <h3>🔮 ব্যক্তিগত পরামর্শ নিন</h3>
    <p>হস্তরেখা বিচার &middot; জন্মকুণ্ডলী বিশ্লেষণ &middot; যোটোক মিলন<br><strong>Dr. Prodyut Acharya</strong> &mdash; PhD Gold Medalist &middot; রানাঘাট</p>
    <button class="btn-book-cta" onclick="openSvcSelector()"><i class="fas fa-calendar-check"></i> পরামর্শ বুক করুন</button>
    ...
    <p style="font-size:.72rem;margin-top:10px;opacity:.6;"><i class="fas fa-lock" style="color:var(--gold3);margin-right:4px;"></i>Razorpay দ্বারা সুরক্ষিত &bull; UPI &bull; Card &bull; Net Banking</p>
  </div>
  <div class="author-bio">
    ...
    <div>
      ...
      <p>১৫+ বছরের অভিজ্ঞতায় হাজারো জন্মকুণ্ডলী ও হস্তরেখা বিশ্লেষণ করেছেন। <a href="https://www.myastrology.in/about.html">&rarr; আরও জানুন</a></p>
    </div>
  </div>
  <div class="related">
  ...
  <div class="ftr-top">
    <div class="ftr-top-inner">
      <div class="ftr-brand-block">
        <img src="https://www.myastrology.in/images/MyAstrology-Ranghat-logo.png" alt="MyAstrology" class="ftr-logo" width="52" height="52" loading="lazy">
        <div>
...
<div id="svc-overlay" role="dialog" aria-modal="true" aria-labelledby="svcTitle">
  <div id="svc-modal">
    ...
    <div class="bm-header">
      <img src="https://www.myastrology.in/images/MyAstrology-Ranghat-logo.png" alt="MyAstrology" class="bm-logo">
...
<div id="book-overlay" role="dialog" aria-modal="true" aria-labelledby="bookModalTitle">
  <div id="book-modal">
    ...
    <div class="bm-header">
      <img src="https://www.myastrology.in/images/MyAstrology-Ranghat-logo.png" alt="MyAstrology Logo" class="bm-logo">
...
<div id="rzp-success-overlay" role="dialog" aria-modal="true">
  <div id="rzp-success-modal">
    ...
    <a id="successWaBtn" href="#" target="_blank" rel="noopener" class="success-wa-btn"><i class="fab fa-whatsapp"></i>&nbsp;WhatsApp-এ তথ্য পাঠান</a>
...
document.addEventListener('click',function(e){var n=document.getElementById('navMenu'),h=document.querySelector('.ham');if(n.classList.contains('open')&&!n.contains(e.target)&&!h.contains(e.target)){closeNav();}});
document.querySelectorAll('#navMenu a').forEach(function(a){a.addEventListener('click',function(){closeNav();});});
...
var _svc={label:'',amount:0,price:'',oldprice:''};var WA_NUM='919333122768';var RZP_KEY='rzp_live_SN8p6DJxPYFVL1';var RZP_LOGO='https://www.myastrology.in/images/MyAstrology-Ranghat-logo.png';
...
function showSuccess(name,phone,pid){var NL='\n';var msg='\ud83d\ude4f \u09a8\u09ae\u09b8\u09cd\u0995\u09be\u09b0! \u0986\u09ae\u09bf '+_svc.label+'-\u098f\u09b0 \u099c\u09a8\u09cd\u09af \u09aa\u09c7\u09ae\u09c7\u09a8\u09cd\u099f \u09b8\u09ae\u09cd\u09aa\u09a8\u09cd\u09a8 \u0995\u09b0\u09c7\u099b\u09bf\u0964'+NL+NL+'\ud83d\udc64 \u09a8\u09be\u09ae: '+name+NL+'\ud83d\udcf1 WhatsApp: +91'+phone+NL+'\ud83d\uded2 \u09b8\u09c7\u09ac\u09be: '+_svc.label+NL+(_svc.price?'\ud83d\udcb0 \u09ae\u09c2\u09b2\u09cd\u09af: \u20b9'+_svc.price+NL:'')+(pid?'\ud83c\udd94 Payment ID: '+pid:'')+NL+NL+'\ud83d\udccb \u09aa\u09b0\u09be\u09ae\u09b0\u09cd\u09b6\u09c7\u09b0 \u09a4\u09be\u09b0\u09bf\u0996 \u0993 \u09b8\u09ae\u09af\u09bc \u099c\u09be\u09a8\u09be\u09a8\u0964 \u09a7\u09a8\u09cd\u09af\u09ac\u09be\u09a6! \ud83d\ude4f';document.getElementById('successWaBtn').href='https://wa.me/'+WA_NUM+'?text='+encodeURIComponent(msg);document.getElementById('successMsg').textContent=name+' \u2014 \u0986\u09aa\u09a8\u09be\u09b0 \u09aa\u09c7\u09ae\u09c7\u09a8\u09cd\u099f \u09b8\u09ab\u09b2\u09ad\u09be\u09ac\u09c7 \u0997\u09c3\u09b9\u09c0\u09a4 \u09b9\u09af\u09bc\u09c7\u099b\u09c7\u0964 \u2705';document.getElementById('successPid').textContent=pid||'\u2014';var ov=document.getElementById('rzp-success-overlay');ov.style.display='flex';requestAnimationFrame(function(){ov.classList.add('show');});document.body.style.overflow='hidden';}
