...
function proceedToRazorpay(){
  ...
  new Razorpay({key:RZP_KEY,amount:_svc.amount,currency:'INR',name:'MyAstrology',description:_svc.label,image:RZP_LOGO,
    ...
    handler:function(res){closeBooking();if(typeof gtag!=='undefined')gtag('event','booking_paid',{event_category:'conversion',event_label:_svc.label,value:_svc.amount/100});showSuccess(name,phone,res.razorpay_payment_id);}
  }).open();
}
...
${CSS_BLOCK}
<!-- ★ FIX 5: Analytics deferred (2s পরে) + Bug সংশোধিত -->
<script>
window.addEventListener('load',function(){
  setTimeout(function(){
    /* GTM */
    (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-MVVL8XBD');
    /* GA4 — FIX: আগের ফাইলে d, s undefined bug ছিল, এখন সংশোধিত */
    var ga=document.createElement('script');ga.async=true;
    ga.src='https://www.googletagmanager.com/gtag/js?id=G-S7BQGLP211';
    document.head.appendChild(ga);
    window.dataLayer=window.dataLayer||[];
    function gtag(){dataLayer.push(arguments);}
    gtag('js',new Date());gtag('config','G-S7BQGLP211');
  },2000);
});
</script>
...
console.log('🔧 PageSpeed Fixes Applied:');
